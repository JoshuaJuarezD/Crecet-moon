...
public class ventanaPrincipal extends javax.swing.JFrame {
    ...
    public void iniciar(){
        ...
        this.setBounds((ancho / 2) - (this.getWidth() / 2), (alto / 2) - (this.getHeight() / 2), 840, 420);
    ...
    private void initComponents() {
        ...
        jButton1.setText("agregar proovedor");
        ...
        jButton3.setText("crear Etiqueta");
        ...
        jButton4.setText("Eliminar Proovedor");

        jButton5.setText("Eliminar etiqueta");
        ...
        jButton6.setText("Eliiminar producto");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CrearEtiqueta ventana=new CrearEtiqueta();
        ventana.iniciar();
