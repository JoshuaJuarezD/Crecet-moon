...
public class AgregarProducto extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (jTable1.getSelectedRow() == -1) {
            ...
            String aux[]=jList1.getSelectedValue().split("-");
            String idproveedor=aux[0].trim();
            ...
            Reporte reporte = new Reporte("RE0"+Reportesexistentes.size(), 1 , new Date(), idproducto, idproveedor,idetiquetas , cantidad, costo);
            Reportesexistentes.add(reporte);
            io.escrituraProducto(productos);
            io.escrituraReporte(Reportesexistentes);
            JOptionPane.showMessageDialog(new JFrame(), "Productos agregados correctamente", "Producto agregado", JOptionPane.INFORMATION_MESSAGE);
